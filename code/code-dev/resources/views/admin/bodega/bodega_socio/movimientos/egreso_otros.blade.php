        ...
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-header">
                    <h2 class="title"><i class="fas fa-plus-circle"></i><strong> Registro De Egresos A Bodega - Otros Insumos</strong></h2>
                    
                </div>

                <div class="card-body">
                    {!! Form::hidden('tipo_egreso', 1, ['class'=>'form-control', 'id'=>'tipo_egreso']) !!}
                    {!! Form::open(['url' => '/admin/bodega_socio/insumo/egresos/otros_insumos', 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mtop16" style="border-right: 2px dashed; ">
                                    ...
                                    <label for="name" class="mtop16"> <strong><sup ><i class="fa-solid fa-triangle-exclamation"></i></sup> Tipo de Kit a Despachar: </strong></label>
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-layer-group"></i></span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="name"> <strong><sup ><i class="fa-solid fa-triangle-exclamation"></i></sup> Presentacion: </strong></label>
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                                    {!! Form::number('presentacion', null, ['class'=>'form-control', 'id' => 'presentacion', 'readonly']) !!}
                                </div> 
                            </div>
...
<script>
    ...
    function agregar(){
        ...
        if (idinsumo!="" && no_unidades > 0 &&  ( no_unidades_disponibles - no_unidades) >= 0  ){
            var fila='<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idinsumo[]" value="'+idinsumo+'">'+insumo+'</td><td><input type="number" name="no_unidades[]" value="'+no_unidades+'"></td></tr>';
            cont++;
            limpiar();
            evaluar();
