        ...
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-header">
                    <h2 class="title"><i class="fas fa-plus-circle"></i><strong> Registro De Ingresos A Bodega - Otros Insumos</strong></h2>
                    
                </div>

                <div class="card-body">
                    {!! Form::open(['url' => '/admin/bodega_socio/insumo/ingresos/otros_insumos', 'files' => true]) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mtop16" style="text-align: center;">
                                <span style="color:red;"><b><i class="fa-solid fa-circle-exclamation"></i> Utilice uno de las dos opciones de procedencia de las insumos; Usar las dos en un mismo ingreso podria generar un error.</b></span>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="name"> <strong><sup ><i class="fa-solid fa-triangle-exclamation"></i></sup> Presentación: </strong></label>
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                                    {!! Form::select('idpresentacion', obtenerDocumentosIngreso('list', null),1,['class'=>'form-select','id'=>'idpresentacion']) !!}
                                </div>
                            </div>

                            <div class="col-md-3">
                                <label for="name"> <strong><sup ><i class="fa-solid fa-triangle-exclamation"></i></sup> Observación/Comentarios: </strong></label>
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
                                    {!! Form::textarea('observaciones', null,['class'=>'form-control', 'id' => 'observaciones', 'rows'=>'1']) !!}
                                </div>
                            </div>
...
<script>
    ...
    function agregar(){
        ...
        presentacion=$("#idpresentacion option:selected").text();
        observaciones=$("#observaciones").val();

        if (idinsumo!=""  ){
            var fila='<tr class="selected" id="fila'+cont+'"><td><button type="button" class="btn btn-warning" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idinsumo[]" value="'+idinsumo+'">'+insumo+'</td><td><input type="number" name="no_unidades[]" value="'+no_unidades+'"></td><td><input type="hidden" name="idpresentacion[]" value="'+idpresentacion+'">'+presentacion+'</td><td><input type="text" name="observaciones[]" value="'+observaciones+'"></td></tr>';
            cont++;
            limpiar();
            evaluar();
