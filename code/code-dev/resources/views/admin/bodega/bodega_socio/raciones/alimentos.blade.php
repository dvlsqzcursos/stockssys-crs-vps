    ...
    <div class="row">
        ...
        <div class="col-md-9"> 
            <div class="card ">
                ...
                <div class="card-header">
                    <h2 class="card-title"><i class="fa-solid fa-bowl-rice"></i> <strong> Listados de Alimentos Que Conforman La Ración: </strong> {{ $racion->nombre }}</h2>
                    <ul>                                             
                        <li>
                            <a href="{{ url('/admin/bodega_socio/raciones/1') }}" ><i class="fa-solid fa-circle-arrow-left"></i> Regresar</a>
                        </li>
                    </ul>
                </div>
