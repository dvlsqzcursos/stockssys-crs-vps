...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ url('/admin/bodega_principal/ingresos') }}"><i class="fa-solid fa-calculator"></i> Registro de Ingresos</a></li>
@endsection
...
@include('admin.bodega.bodega_principal.scripts')
