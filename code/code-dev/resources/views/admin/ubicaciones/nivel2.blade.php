    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card ">
                ...
                <div class="card-header">
                    <h2 class="title"><i class="fas fa-plus-circle"></i><strong> Registrar Ubicación Nivel 2</strong></h2>
                </div>

                <div class="card-body">
                    {!! Form::open(['url' => '/admin/ubicacion/n2/registrar', 'files' => true]) !!}
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::select('nivel', ['3' => 'Nivel 2'],1,['class'=>'form-select']) !!}
                        </div>
        ...
        <div class="col-md-8">
            <div class="card ">
                ...
                <div class="card-header">
                    <h2 class="title"><i class="fas fa-file-alt"></i> <strong> Listados de Ubicaciones Nivel 2 - {{ $ubicacion_principal_n1->nombre }}</strong></h2>
                </div>
