...
<body style="background-image: url('/static/imagenes/crs_1.png'); ">
    @foreach($despachos as $d)
        ...
        <div style="position: relative; top: 21.2mm; left: 170mm;  width: 250px; height: 10px; font-size: 12px;">
            {{ $d->participantes }}           
        </div>

        <div style="position: relative; top: 29.2mm; left: 170mm;  width: 250px; height: 10px; font-size: 12px;">
